...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header text-right">{{ __('admin.Register') }}</div>
                        ...
                        <form method="POST" action="{{ route('admin.register') }}">
                            ...
                            <div class="form-group row">
                                <label for="department"
                                       class="col-md-4 col-form-label text-md-right">{{ __('admin.department') }}</label>

                                <div class="col-md-6">
                                    <select id="department" class="form-control"
                                            name="department">
                                        <option value="0">@lang('admin.support')</option>
                                        <option value="1">@lang('admin.tech')</option>
                                        <option value="2">@lang('admin.financial')</option>
                                    </select>
                                </div>
                            </div>
